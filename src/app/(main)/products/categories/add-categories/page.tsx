        ...
        <main className="min-h-[80vh] flex items-center p-10 justify-center">
            <div className="w-full flex-col text-white flex gap-y-3 justify-center items-center max-w-sm">
                ...
                <div className="w-full gap-y-2 flex mt-3 flex-col justify-center items-center">
                    <input name='code' placeholder="Acompanhamento, Bebidas ou Sobremesas..." type="text" className="flex placeholder:text-primary-secundary placeholder:text-xs w-full p-2 bg-transparent border text-sm border-primary-light text-white rounded-md" />
                </div>

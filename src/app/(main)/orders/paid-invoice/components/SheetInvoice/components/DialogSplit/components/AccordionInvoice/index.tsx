...
type AccordionInvoiceProps = {
    ...
    persons: Person[]
    dataCopy: ProductsInvoice[] | undefined
...
const AccordionInvoice: React.FC<AccordionInvoiceProps> = ({ data, persons, dataCopy, setData, setPerson, setSelectedPerson, setIsActiveBtn }) => {
